...
<div id="inicio" class="card container col-8" style="padding-top: 5px; margin-top: 20px;">
  ...
  <div class="card-body">
    <p class="card-text">Grey's Anatomy es una série de estadunidense de drama médico exibida no horário nobre da rede ABC. Seu episódio piloto foi transmitido pela primeira vez em 27 de março de 2005 nos Estados Unidos. A série é protagonizada por Ellen Pompeo, que interpreta Meredith Grey, inicialmente interna do fictício hospital cirúrgico Seattle Grace (mais tarde Hospital Memorial Grey-Sloan), em Seattle, Washington, um dos programas de residência em cirurgia médica mais rígidos do país. A série é focada nela e seus colegas, também internos: Cristina Yang, Isobel Stevens, George O'Malley e Alex Karev, mostrando suas vidas amorosas e as dificuldades pelas quais passam no trabalho. Grey's Anatomy já se estabeleceu como uma das maiores séries americanas dos últimos anos. Com um elenco que se renova a cada ano, enquanto alguns veteranos se despedem de tempos em tempos e novos rostos se juntam à equipe médica.</p>
